...
/**
 * Class ImportantInformationConfigDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from ImportantInformationConfigFormBase. The reason for
 ...
 */
class ImportantInformationConfigDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete Important Information Config %label?', [
  ...
  public function getConfirmText() {
    return $this->t('Delete ImportantInformationConfig');
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.important_information_config.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('Important Information Config %label was deleted.', [
      '%label' => $this->entity->label(),
    ]));
